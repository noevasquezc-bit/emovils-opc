...
def agent_contenido():
    ...
    data = request.get_json()
    try:
        from agents.agent_contenido import create_instagram_post
...
def content_calendar():
    ...
    try:
        from agents.agent_contenido import create_7day_content_calendar
...
def daily_report():
    ...
    try:
        from agents.agent_analytics import generate_daily_report
...
def health_check_pilot():
    ...
    try:
        from agents.agent_analytics import pilot_health_check
